<!-- Reference: what a healthy root CLAUDE.md for this repo looks like. Used in Lab 2 extra credit. -->
...
**i18n**: en/ja locales with USD/JPY conversion in client/src/utils/currency.js
